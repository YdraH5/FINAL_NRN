                    ...
                    <x-slot name="body">
                        ...
                        <div class="flex justify-end space-x-2 mt-4">
                            <button wire:click="sendReminderEmail({{ $apartments->user_id }}, {{ $unpaidDues->isNotEmpty() ? $daysOverdue : 0 }})"
                                    ...
                                    wire:target="sendReminderEmail"
                                    type="button"
                                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex items-center justify-center">

                                <!-- Spinner and text while loading -->
                                <span wire:loading.class.remove="hidden" wire:target="sendReminderEmail" class="hidden flex items-center">
                                    <svg class="animate-spin -ml-1 mr-2 h-5 w-5 text-white inline"
                                ...
                                <!-- Default button text -->
                                <span wire:loading.class.add="hidden" wire:target="sendReminderEmail">
                                    Send Reminder
                                </span>
                            </button>

                            <button x-on:click="$dispatch('close-modal',{name:'unpaid-modal-{{ $apartments->user_id }}'})"
